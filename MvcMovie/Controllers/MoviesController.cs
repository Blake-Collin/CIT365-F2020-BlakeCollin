...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(MvcMovieContext context, IWebHostEnvironment hosting)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Title,ReleaseDate,Genre,Price,Rating,Photo")] MovieCreateViewModel model)
        {
